        ...
        <div>
            <form action="/user/login" method="POST">
                ...
                <label class="input validator">
                    ...
                    <input type="text" required placeholder="Username" name="login" pattern="[A-Za-z][A-Za-z0-9\-]*"
                ...
                <p><a id="hereLink" href="create">Don't have an account yet? Make one here!</a></p>
                </div>
            </form>
        </div>
    </div>
